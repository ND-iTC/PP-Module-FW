...
<<tbl-coverage-mandatory,Table 6: SFR Coverage Mapping for Mandatory SFRs>>

<<tbl-coverage-optional,Table 7: SFR Coverage Mapping for Optional SFRs>>

<<tbl-sufficiency,Table 8: SFR Sufficiency Rationale>>
