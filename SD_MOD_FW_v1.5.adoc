...
V2.0 December 2025 (Updated version for NDcPP V4.0; CC:2022)
...
+
[loweralpha]
.. PP-Configuration for Stateful Traffic Filter Firewalls, version 2.0 draft [CONF-FW].
...
Version 2.0 draft, 02 December 2025
