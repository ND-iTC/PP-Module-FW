...
|[SD-FW] |Evaluation Activities for Stateful Traffic Filter Firewalls PP-Configuration, Version 2.0 draft, 30 November 2025
...
|2.0 draft |30-November-2025 |Version for NDcPP V4.0
|1.5 |30-November-2025 |Addressing comments from CCMB
...
This PP-Module Base is valid because a firewall exists on the edge of a private network providing security and traffic filtering. This is functionality that typically will be implemented by a network device.
...
PP-Module Date: 30-November-2025
...
The Security Assurance Requirements are fully inherited from the PP-Module Base. The evaluation activities from [SD-FW] & [SD-ND] shall be used for the evaluation.
